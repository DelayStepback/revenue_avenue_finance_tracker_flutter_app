...
const TransactionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'paymentType': PropertySchema(
      ...
      name: r'paymentType',
      type: IsarType.string,
      enumMap: _TransactionpaymentTypeEnumValueMap,
    ),
    r'transactionCategory': PropertySchema(
      id: 5,
...
int _transactionEstimateSize(
  ...
  {
    final list = object.transactionCategory;
    if (list != null) {
      bytesCount += 3 + list.length * 3;
      {
        final offsets = allOffsets[TransactionCategory]!;
        for (var i = 0; i < list.length; i++) {
          final value = list[i];
          bytesCount += TransactionCategorySchema.estimateSize(
...
void _transactionSerialize(
  ...
  writer.writeString(offsets[4], object.paymentType?.name);
  writer.writeObjectList<TransactionCategory>(
    offsets[5],
    allOffsets,
...
Transaction _transactionDeserialize(
  ...
  final object = Transaction(
    ...
    paymentType: _TransactionpaymentTypeValueEnumMap[
        reader.readStringOrNull(offsets[4])],
    transactionCategory: reader.readObjectList<TransactionCategory>(
      offsets[5],
      TransactionCategorySchema.deserialize,
      allOffsets,
      TransactionCategory(),
    ),
    type: _TransactiontypeValueEnumMap[reader.readStringOrNull(offsets[6])],
  );
  return object;
}
...
P _transactionDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 4:
      return (_TransactionpaymentTypeValueEnumMap[
          reader.readStringOrNull(offset)]) as P;
    case 5:
      return (reader.readObjectList<TransactionCategory>(
        offset,
        TransactionCategorySchema.deserialize,
        allOffsets,
        TransactionCategory(),
...
const _TransactionpaymentTypeEnumValueMap = {
  r'card': r'card',
  r'cash': r'cash',
};
const _TransactionpaymentTypeValueEnumMap = {
  r'card': PaymentType.card,
...
extension TransactionQueryFilter
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'transactionCategory',
      ));
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterFilterCondition>
      transactionCategoryIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'transactionCategory',
      ));
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition>
      transactionCategoryLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition>
      transactionCategoryLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition>
      transactionCategoryLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition>
      transactionCategoryLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition> typeIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'type',
      ));
...
extension TransactionQueryObject
    on QueryBuilder<Transaction, Transaction, QFilterCondition> {
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition>
      transactionCategoryElement(FilterQuery<TransactionCategory> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'transactionCategory');
    });
  }
}
...
extension TransactionQueryProperty
  ...
  QueryBuilder<Transaction, PaymentType?, QQueryOperations>
      paymentTypeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Transaction, List<TransactionCategory>?, QQueryOperations>
      transactionCategoryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'transactionCategory');
    });
  }
